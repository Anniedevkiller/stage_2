...
const HeroSection = () => {
  return (
    <section className="flex justify-between items-center md:flex-row flex-col items-center justify-between">
...
const CatSection = () => {
  return (
    ...
    <div className="grid grid-cols-4 mt-10 md:grid-cols-3 lg:grid-cols-4">
      <div>
        <div className="mt-4">
          <img src="/1.png" alt="" />
